...
public class OIESettings extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.dialog_oie_settings, null);
        ...
        builder.setTitle("Mosh settings")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        NavHostFragment.findNavController(getParentFragment()).navigate(R.id.progressOIEFragment);
                    }
                });
